...
class Main extends PluginBase implements Listener{
    ...
    public function onDamage(EntityDamageEvent $event) : void{
        ...
        if($entity instanceof Player){
        	...
        	$rejectedCauses = [$event::CAUSE_STARVATION, $event::CAUSE_VOID, $event::CAUSE_FALL, $event::CAUSE_LAVA, $event::CAUSE_FIRE];

        	if(!in_array($event->getCause(), $rejectedCauses)){
	        if($entity->isCreative()){  // now if you're in creative flying won't be disabled //
